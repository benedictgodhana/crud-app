...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="md-3">
            ...
            <input type="text"  class="form-control" name="phone" placeholder="Enter phone number" value="<?php echo e(old('phone')); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="md-3">
            ...
            <textarea type="text"  class="form-control" name="address" placeholder="Enter Address" value="<?php echo e(old('address')); ?>"></textarea>
...
</html><?php /**PATH /var/www/html/CRUD/resources/views/add-student.blade.php ENDPATH**/ ?>